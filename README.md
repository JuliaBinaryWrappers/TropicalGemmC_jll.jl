...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/2df21ede9decc9b0645fba4459eed3e8a2e624fb/T/TropicalGemmC/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* `LibraryProduct`: `TropicalAndOr_Bool`
* `LibraryProduct`: `TropicalMaxPlus_FP32`
* `LibraryProduct`: `TropicalMaxPlus_FP64`
* `LibraryProduct`: `TropicalMinPlus_FP32`
* `LibraryProduct`: `TropicalMinPlus_FP64`
